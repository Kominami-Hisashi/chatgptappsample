class Adviser9Controller < ApplicationController
  before_action :set_token

  def  index
    @chats = Chat.where(adviser_type: "adviser9")
  end
  ...
  def search
    ...
    Chat.create(user_message: text, bot_message: bot_message, adviser_type: "adviser9")
